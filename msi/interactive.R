...
local_cluster <- makeCluster(2) #MSI, instructed to only use 2 cores
...
write.csv(c(execNP = exec_time_np, execP = exec_time_p), "../interactive.csv") #saving in home directory, which is my Project12 folder
